 ...
 */
public class JumpDiffusionMonteCarloBlackScholesModel extends AbstractModel implements AssetModelMonteCarloSimulationInterface {
	 ...
	 */
	public JumpDiffusionMonteCarloBlackScholesModel(
...
/* do we need this?*/
	...
	public AssetModelMonteCarloSimulationInterface getCloneWithModifiedData(Map<String, Object> dataModified) {
		...
		return new JumpDiffusionMonteCarloBlackScholesModel(newInitialValue, newRiskFreeRate, newVolatility, process, 
	...
	public AssetModelMonteCarloSimulationInterface getCloneWithModifiedSeed(int seed) {
		...
		return new JumpDiffusionMonteCarloBlackScholesModel(initialValue, riskFreeRate, volatility, process, poissonIntensity, jumpMean, jumpVariance);
	}
