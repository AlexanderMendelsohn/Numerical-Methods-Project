...
public class SimpleBlackScholesMonteCarloValuation {
	...
	public static void main(String[] args) throws CalculationException {
		...
		System.out.println("Printing results for: riskFreeRate= " + riskFreeRate
				...
				+ ", nu= " + nu);
		System.out.println("Strike |" + " "  +  "Price B&S |"  + " " + "Price JUMP |"
				+ " " + "implied Vola B&S |" + " "  + "implied vola jump |"
				/*+ " " + "payoff B&S |"  + " " + "payoff JUMP |" 
				+ " " + "implied Vola B&S |" + " "  + "implied vola jump"*/);
		for (int i = 0; i < 12; i++){
			System.out.println(strikes[i]
					+ "  " + formatterSci6.format(priceOfBlackScholes[i]) 
					+ "  " + formatterSci6.format(priceOfJumpProcess[i])
					+ "  " + formatterSci6.format(impliedVolatilityBlackScholesByPrice[i])
