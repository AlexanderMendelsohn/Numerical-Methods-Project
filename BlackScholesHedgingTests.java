...
public class BlackScholesHedgingTests {
	...
	public static void main(String[] args) throws CalculationException {
        ...
        for (int i=0;i<sizeOfHedgingTimesVector;i++){
        	...
        	//if (numberOfHedgingTimesVector[i] = x) <- to print more results
        	...
        	System.out.println("------------------------------------------------------------------");
        	System.out.println("Variance of P&L for the BlackScholesModel:");
        	System.out.println(relativePandLBlackScholes[i].getVariance());
        	System.out.println("------------------------------------------------------------------");
        	System.out.println("Variance of P&L for the Merton-Jump-Diffusion-Model: ");
        	System.out.println(relativePandLJump[i].getVariance());
        	System.out.println("==================================================================");
        }
    	...
    	System.out.println("------------------------------------------------------------------");
    	System.out.println("Variance of P&L for the Merton-Jump-Diffusion-Model via Delta-Gamma-Hedging: ");
  		System.out.println(relativePandLBlackJumpDeltaGamma.getVariance());
