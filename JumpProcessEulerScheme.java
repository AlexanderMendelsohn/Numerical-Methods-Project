...
import net.finmath.stochastic.RandomVariableInterface;
	 ...
	 * @version 1.4
	 */
	public class JumpProcessEulerScheme extends AbstractProcess {
		...
		public JumpProcessEulerScheme(BrownianMotionInterface brownianMotion, PointProcessInterface compoundPoissonProcess) {
	 ...
	 // End for(timeIndex)
		 ...
		 */
		@Override
		public JumpProcessEulerScheme clone() {
			return new JumpProcessEulerScheme(getBrownianMotion(), getCompoundPoissonProcess());
		}
